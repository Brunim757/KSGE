...
4. **Código de Produção Real (Proibidos Stubs):** Nenhum stub, placeholder, exemplo didático, pseudo-código ou código morto é aceito. Todo código entregue deve ser produção-grade, avançado, funcional e executável, como parte integrada da engine.
